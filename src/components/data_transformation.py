...
from src.utils.common import save_bin, read_yaml,save_array
...
class DataTransformation:
    ...
    def initiate_data_transformation(self)->DataTransformationArtifact:
        ...
        try:
            ...
            df_train=DataTransformation.read_file(train_file_path)
            df_test=DataTransformation.read_file(test_file_path)
            ...
            save_array(self.data_transformation_config.transformed_train_file_path,
                     train_arr)
            save_array(self.data_transformation_config.transformed_test_file_path,
                     test_arr)
